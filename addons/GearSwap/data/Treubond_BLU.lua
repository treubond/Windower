...
function init_gear_sets()
    ...
    sets.precast.JA['Chain Affinity'] = {head="Hashishin Kavuk +2"}
    ...
    sets.precast.WS['Requiescat'] = set_combine(sets.precast.WS, {neck="Fotia Gorget",waist="Fotia Belt",}) -- 73-85% MND

    sets.precast.WS['Requiescat'].Acc = set_combine(sets.precast.WS['Requiescat'], {})

    sets.precast.WS['Expiacion'] = sets.precast.WS['Savage Blade'] -- 30% STR / 30% INT / 20% DEX
