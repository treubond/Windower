...
function get_sets()
    ...
    sets.midcast.BP = {
		...
		right_ear="Loquacious Earring", -- +2
		left_ring="Tali'ah Ring",
		right_ring={ name="Beck. Earring", augments={'System: 1 ID: 1676 Val: 0','Pet: Accuracy+6 Pet: Rng. Acc.+6','Pet: Mag. Acc.+6',}},
		back={ name="Campestres's Cape", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Pet: Haste+6',}},
		-- main={ name="Espiritus", augments={'Summoning magic skill +15','Pet: Mag. Acc.+30','Pet: Damage taken -4%',}},
		-- sub="Vox Grip",
		-- ammo="Sancus Sachet +1",
		-- head="Beckoner's Horn +2", -- Always use Beckoner's Horn here.
	...
	-- Note: Similar to "sets.aftercast.DD.Avatar". If you change one don't forget to change the other accordingly.
	...
	if pet.isvalid then
		if pet.name=='Fenrir' then
			send_command('input /macro book 4;wait 1;input /macro set 2;wait 3;input /lockstyle on') --set '..StartLockStyle)
		elseif pet.name=='Ifrit' then
			send_command('input /macro book 4;wait 1;input /macro set 3;wait 3;input /lockstyle on') --set '..StartLockStyle)
		elseif pet.name=='Titan' then
			send_command('input /macro book 4;wait 1;input /macro set 4;wait 3;input /lockstyle on') --set '..StartLockStyle)
		elseif pet.name=='Leviathan' then
			send_command('input /macro book 4;wait 1;input /macro set 5;wait 3;input /lockstyle on') --set '..StartLockStyle)
		elseif pet.name=='Garuda' then
			send_command('input /macro book 4;wait 1;input /macro set 6;wait 3;input /lockstyle on') --set '..StartLockStyle)
		elseif pet.name=='Shiva' then
			send_command('input /macro book 4;wait 1;input /macro set 7;wait 3;input /lockstyle on') --set '..StartLockStyle)
		elseif pet.name=='Ramuh' then
			send_command('input /macro book 4;wait 1;input /macro set 8;wait 3;input /lockstyle on') --set '..StartLockStyle)
		elseif pet.name=='Diabolos' then
			send_command('input /macro book 4;wait 1;input /macro set 9;wait 3;input /lockstyle on') --set '..StartLockStyle)
		elseif pet.name=='Cait Sith' then
			send_command('input /macro book 11;wait 1;input /macro set 2;wait 3;input /lockstyle on') --set '..StartLockStyle)
		elseif pet.name=='Siren' then
			send_command('input /macro book 11;wait 1;input /macro set 4;wait 3;input /lockstyle on') --set '..StartLockStyle)
		end
	else
		send_command('input /macro book 4;wait .1;input /macro set 1;wait 3;input /lockstyle on') --set '..StartLockStyle)
	end
