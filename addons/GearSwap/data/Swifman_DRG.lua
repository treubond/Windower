...
function user_job_setup()
	...
	state.Weapons:options('Trishula','Sword','SO')
	state.Passive = M{['description'] = 'Passive Mode','None','MP','Twilight'}
	
	gear.da_jse_back = {name="Brigantia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Dbl.Atk."+10','Phys. dmg. taken-10%',}}
	gear.ws_jse_back = {name="Brigantia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','Weapon skill damage +10%','Phys. dmg. taken-10%',}}
...
function init_gear_sets()
	...
	sets.precast.JA.Jump = {ammo="Aurgelmir Orb",
		...
		body="Hjarrandi Breast.",hands="Vis. Fng. Gaunt. +2",ring1="Petrov Ring",ring2="Niqmaddu Ring",
		back="Brigantia's Mantle",waist="Ioskeha Belt +1",legs="Ptero. Brais +3",feet="Ostro Greaves"}
	sets.precast.JA['Ancient Circle'] = {} --legs="Vishap Brais"
	sets.precast.JA['High Jump'] = {ammo="Aurgelmir Orb",
		head="Flam. Zucchetto +2",neck="Vim Torque +1",ear1="Telos Earring",ear2="Sherida Earring",
		body="Hjarrandi Breast.",hands="Vis. Fng. Gaunt. +2",ring1="Petrov Ring",ring2="Niqmaddu Ring",
		back="Brigantia's Mantle",waist="Ioskeha Belt +1",legs="Ptero. Brais +3",feet="Ostro Greaves"}
	sets.precast.JA['Soul Jump'] = {aammo="Aurgelmir Orb",
		head="Flam. Zucchetto +2",neck="Vim Torque +1",ear1="Telos Earring",ear2="Sherida Earring",
		body="Hjarrandi Breast.",hands="Vis. Fng. Gaunt. +2",ring1="Petrov Ring",ring2="Niqmaddu Ring",
		back="Brigantia's Mantle",waist="Ioskeha Belt +1",legs="Ptero. Brais +3",feet="Ostro Greaves"}
	...
	sets.precast.WS['Stardiver'].SomeAcc = set_combine(sets.precast.WS.Acc, {ammo="Coiste Bodhar",head="Peltast's Mezail +3",neck="Fotia Gorget",ear1="Moonshade Earring",ear2="Peltast's Earring",body="Gleti's Cuirass",hands="Gleti's Gauntlets",ring1="Sroda Ring",ring2="Niqmaddu Ring",gear.ws_jse_back,waist="Fotia Belt",legs="Gleti's Breeches",feet="Nyame Sollerets"})
	...
	sets.precast.WS['Sonic Thrust'] = set_combine(sets.precast.WS, {body="Nyame Mail",neck="Dgn. Collar +1",waist="Sailfi Belt +1",ring1="Sroda Ring",ring2="Epaminondas's Ring"})
    sets.precast.WS['Sonic Thrust'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {body="Nyame Mail",neck="Rep. Plat. Medal",waist="Sailfi Belt +1",ring1="Sroda Ring",ring2="Epaminondas's Ring"})
    sets.precast.WS['Sonic Thrust'].Acc = set_combine(sets.precast.WS.Acc, {body="Nyame Mail",neck="Rep. Plat. Medal",waist="Sailfi Belt +1",ring1="Sroda Ring",ring2="Epaminondas's Ring"})
    sets.precast.WS['Sonic Thrust'].FullAcc = set_combine(sets.precast.WS.FullAcc, {body="Nyame Mail",neck="Rep. Plat. Medal",waist="Sailfi Belt +1",ring1="Sroda Ring",ring2="Epaminondas's Ring"})
    sets.precast.WS['Sonic Thrust'].Fodder = set_combine(sets.precast.WS.Fodder, {body="Nyame Mail",neck="Rep. Plat. Medal",waist="Sailfi Belt +1",ring1="Sroda Ring",ring2="Epaminondas's Ring"})	
	
	
	sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS, {body="Nyame Mail",neck="Rep. Plat. Medal",waist="Sailfi Belt +1",ring1="Sroda Ring",ring2="Epaminondas's Ring"})
    sets.precast.WS['Savage Blade'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {body="Nyame Mail",neck="Dgn. Collar +1",waist="Sailfi Belt +1",ring1="Sroda Ring",ring2="Epaminondas's Ring"})
    sets.precast.WS['Savage Blade'].Acc = set_combine(sets.precast.WS.Acc, {body="Nyame Mail",neck="Rep. Plat. Medal",waist="Sailfi Belt +1",ring1="Sroda Ring",ring2="Epaminondas's Ring"})
    sets.precast.WS['Savage Blade'].FullAcc = set_combine(sets.precast.WS.FullAcc, {body="Nyame Mail",neck="Rep. Plat. Medal",waist="Sailfi Belt +1",ring1="Sroda Ring",ring2="Epaminondas's Ring"})
    sets.precast.WS['Savage Blade'].Fodder = set_combine(sets.precast.WS.Fodder, {body="Nyame Mail",neck="Rep. Plat. Medal",waist="Sailfi Belt +1",ring1="Sroda Ring",ring2="Epaminondas's Ring"})
	...
	sets.idle = {ammo="Staunch Tathlum +1",
		head="Hjarrandi Helm",neck="Dgn. Collar +1",ear1="Telos Earring",ear2="Ethereal Earring",
		body="Hjarrandi Breast.",hands="Nyame Gauntlets",ring1="Moonlight Ring",ring2="Moonlight Ring",
		back="Shadow Mantle",waist="Flume Belt +1",legs="Nyame Flanchard",feet="Nyame Sollerets"}
		
	sets.idle.Refresh = {ammo="Staunch Tathlum +1",
		head="Hjarrandi Helm",neck="Loricate Torque +1",ear1="Telos Earring",ear2="Ethereal Earring",
		body="Hjarrandi Breast.",hands="Nyame Gauntlets",ring1="Moonlight Ring",ring2="Moonlight Ring",
		back="Shadow Mantle",waist="Flume Belt +1",legs="Nyame Flanchard",feet="Nyame Sollerets"}
    ...
    sets.engaged.SomeAcc = {ammo="Coiste Bodhar",
		head="Hjarrandi Helm",neck="Dgn. Collar +1",ear1="Telos Earring",ear2="Sherida Earring",
		body="Gleti's Cuirass",hands="Pel. Vambraces +3",ring1="Lehko's Ring",ring2="Niqmaddu Ring",
	...
	sets.engaged.Acc = {ammo="Coiste Bodhar",
		...
		back=gear.da_jse_back,waist="Ioskeha Belt",legs="Ptero. Brais +3",feet="Flam. Gambieras +2"}
    ...
    sets.engaged.Fodder = {ammo="Coiste Bodhar",
		head="Flam. Zucchetto +2",neck="Dgn. Collar +1",ear1="Telos Earring",ear2="Sherida Earring",
		body="Hjarrandi Breast.",hands="Gleti's Gauntlets",ring1="Lehko's Ring",ring2="Moonlight Ring",
		back=gear.da_jse_back,waist="Ioskeha Belt +1",legs="Ptero. Brais +3",feet="Flam. Gambieras +2"}
