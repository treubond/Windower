...
send_command('wait 10;input /lockstyleset 80')
refreshType = idleModes[1] -- leave this as is  
   
function sub_job_change(new,old)
send_command('wait 10;input /lockstyleset 82')
end
...
--------------------    
	EMP = {}		--Leave This Empty
		EMP.HED	= "Fili Calot +3"
		EMP.BOD	= "Fili Hongreline +3"
		EMP.HND	= "Fili Manchettes +3"
		EMP.LEG	= "Fili Rhingrave +3"
		EMP.FEE	= "Fili Cothurnes +3"
--------------------
--[JSE CAPES]-[JSE]
--------------------  
...
---------------
 	sets.me.idle.refresh = {
		...
		back="Solemnity Cape",
	}	-- 9 Refresh :: 49 PDT :: 26 MDT :: 23 BDT
---------------
--[IDLE]-[REFRESH]-[PDT]
---------------
	sets.me.idle.dt = {
...
---------------
	...
	waist="Siegel Sash"}) --8 (76% FC Total w/o Kali) 	
...
---------------
    sets.precast.stoneskin = set_combine(sets.precast.enhancing,{
		head="Umuthi Hat",}) --15  (83% FC Total w/o Kali)
...
---------------
    sets.precast.cure = set_combine(sets.precast.casting,{
		...
		ear1="Mendicant's Earring"}) --(88% FC Total w/o Kali)
