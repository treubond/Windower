...
function job_setup()	
    ...
    state.WeaponSet = M{['description']='Weapon Set', 'Naegling', 'GAxe'}--, 'ShiningOne', 'Club', 'Montante', 'Reikiono', 'Naegling'}
...
-------------------------------------------------------------------------------------------------------------------
    ...
    sets.precast.WS = {
        ...
        body={ name="Valorous Mail", augments={'AGI+9','Weapon skill damage +5%','Accuracy+9 Attack+9',}},
        hands={ name="Valorous Mitts", augments={'"Occult Acumen"+10','Attack+6','Weapon skill damage +6%','Accuracy+7 Attack+7','Mag. Acc.+15 "Mag.Atk.Bns."+15',}},
        ...
        back={ name="Mauler's Mantle", augments={'DEX+2','STR+1',}},
    }
...
-------------------------------------------------------------------------------------------------------------------
    ...
    sets.engaged = {
        ...
        hands={ name="Valorous Mitts", augments={'"Occult Acumen"+10','Attack+6','Weapon skill damage +6%','Accuracy+7 Attack+7','Mag. Acc.+15 "Mag.Atk.Bns."+15',}},
        legs={ name="Valorous Hose", augments={'Accuracy+22 Attack+22','Weapon skill damage +1%','Accuracy+12',}},
...
-------------------------------------------------------------------------------------------------------------------
    ...
    sets.GAxe        = {main="Hepatizon Axe", sub="Utu Grip",}
