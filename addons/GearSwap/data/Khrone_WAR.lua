...
function init_gear_sets()
	...
	EMPY.Body = "Boii Lorica +2"
	EMPY.Hands = "Boii Mufflers +2"
	EMPY.Legs = ""
	EMPY.Feet = ""
...
-------------------------------------------------------------------------------------------------------------------
	...
	-- Job Abilities
    sets.precast.JA['Berserk']              = { body=AF.Body,}
    sets.precast.JA['Retaliation'] 			= { --[[ hands = AF.Hands, feet = EMPY.Feet ]] }
    sets.precast.JA['Restraint'] 			= { hands = EMPY.Hands, }
    sets.precast.JA['Warcry'] 				= { --[[ head = Relic.Head ]] }
