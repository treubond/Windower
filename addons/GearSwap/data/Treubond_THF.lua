...
function init_gear_sets()
    ...
    sets.precast.WS['Rudra\'s Storm'].Acc = set_combine(sets.precast.WS['Rudra\'s Storm'], { --Physical  80% DEX
        --[[ ammo="Voluspa Tathlum",
        ear2="Telos Earring",
        waist="Grunfeld Rope", ]]
        })
    ...
    sets.precast.WS['Aeolian Edge'] = set_combine(sets.precast.WS, {  --Magical  40% INT / 40% DEX
        ammo="Per. Lucky Egg",
        head={ name="Nyame Helm", augments={'Path: B',}},
        body={ name="Nyame Mail", augments={'Path: B',}},
        hands="Asn. Armlets +2",
