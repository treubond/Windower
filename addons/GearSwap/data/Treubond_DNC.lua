...
state.WeaponMode:options('Gletis','Aeneas','Karambit')
state.WeaponMode:set('Gletis')
...
function get_sets()
	...
	sets.Weapons['Gletis'] = {main="Gleti's Knife", sub="Ternion Dagger",}
	...
	-------------------------------------------------------------------------------
	sets.Jig = set_combine(sets.Idle.DT, {f--[[ eet="Maxixi Toe Shoes", ]]}) -- Horos Tights +3 and Maxixi Toe Shoes +3
