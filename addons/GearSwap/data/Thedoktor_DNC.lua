...
state.WeaponMode:options('Gleti','Aeneas','Karambit','Evisceration')
state.WeaponMode:set('Gleti')
...
function get_sets()
	...
	sets.Weapons['Gleti'] = {main="Gleti's Knife", sub="Taming Sari",}
	...
	-------------------------------------------------------------------------------
	sets.Jig = sets.Idle.DT --set_combine(sets.Idle.DT, --[[ {feet="Maxixi Toe Shoes",} ]]) -- Horos Tights +3 and Maxixi Toe Shoes +3
