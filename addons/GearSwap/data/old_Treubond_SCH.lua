...
--[[        ammo="Ghastly Tathlum +1",
    ...
    sets.midcast.Cure = { --51
        main="Daybreak", --30
        sub="Culminus",
        ammo="Clarus Stone",
        head="Jhakri Coronal +2",
        body="Jhakri Robe +2",
        hands={ name="Telchine Gloves", augments={'Spell interruption rate down -10%',}}, --10
        legs="Jhakri Slops +2",
        feet="Mallquis Clogs",
...
--[[         main="Daybreak",
    ...
    sets.idle.DT = set_combine(sets.idle, { --DT 51 + 7%dmg to MP
...
--[[         main="Musa",
    ...
    sets.resting = set_combine(sets.idle, {
        ...
        feet="Yigit Crackows", ]]
        neck={ name="Jeweled Collar", augments={'CHR+2','MP recovered while healing +3','INT+2',}},
        waist="Qiqirn Sash +1",
        left_ear="Magnetic Earring",
