...
sets.brd = {
    wind_inst = {
        range="Pan's Horn"},--put your wind instrument here
    string_inst = {
        range="Ebony Harp +1"},}--put your string instrument here
sets.Idle = {
...
function precast(spell)
    ...
    if gs_skill.skillup_type == "Singing" then
        ...
        --else
        if (gs_skillup.test_mode and gs_skillup.test_brd == "Wind") or not gs_skillup.skill['Wind Instrument Capped'] then
