...
--					[ Windows + F9 ]		Cycle Weapon Skill Mode
...
function init_gear_sets()
    ...
    sets.precast.JA.Meditate = {head="Wakido Kabuto +2",hands={ name="Sakonji Kote", augments={'Enhances "Blade Bash" effect',}},--[[ back={ name="Smertrios's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Store TP"+10','Phys. dmg. taken-10%',}}, ]]}
    sets.precast.JA['Warding Circle'] = {head="Wakido Kabuto +2"}
    sets.precast.JA['Blade Bash'] = {hands={ name="Sakonji Kote", augments={'Enhances "Blade Bash" effect',}},}
    ...
    sets.engaged = {  --STP = 71   DT=38 PDT=6
		...
		legs="Kasuga Haidate +3",  --11  DT 11
		feet="Mpaca's Boots",  --0  PDT 6
		neck={ name="Sam. Nodowa +1", augments={'Path: A',}},  --11
	...
	sets.engaged.Hybrid = { --DT 49 PDT +15
		ammo="Aurgelmir Orb", --0
		head="Kasuga Kabuto +2",  --9
		body="Kasuga Domaru +2",  --13
		hands="Nyame Gauntlets",  --7
		legs="Wakido Haidate +3",  --0
		--legs="Mpaca's Hose",  --PDT -9
		feet="Mpaca's Boots",  --PDT -6
		neck={ name="Sam. Nodowa +1", augments={'Path: A',}},  --5
		waist="Ioskeha Belt +1",  --0
